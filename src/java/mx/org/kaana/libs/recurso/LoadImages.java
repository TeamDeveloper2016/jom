...
public final class LoadImages {
	...
	public static DefaultStreamedContent getFile(String name) throws FileNotFoundException {
		if(Cadena.isVacio(name))
		  ...
		  return file.exists()? new DefaultStreamedContent(new FileInputStream(name), "image/jpg"): new DefaultStreamedContent(new FileInputStream(JsfBase.getRealPath("/resources/janal/img/sistema/logo.svg")), "image/svg+xml");
		} // else	
	} 
