...
@Entity
@Table(name="tc_jom_incidentes_bitacora")
public class TcJomIncidentesBitacoraDto implements IBaseDto, Serializable {
  ...
  public TcJomIncidentesBitacoraDto() {
    this(new Long(-1L));
  }

  public TcJomIncidentesBitacoraDto(Long key) {
    this(null, null, new Long(-1L), null, null);
    setKey(key);
  }

  public TcJomIncidentesBitacoraDto(String justificacion, Long idIncidente, Long idIncidenteBitacora, Long idUsuario, Long idIncidenteEstatus) {
  ...
  public Class toHbmClass() {
    return TcJomIncidentesBitacoraDto.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcJomIncidentesBitacoraDto other = (TcJomIncidentesBitacoraDto) obj;
